<h2><a href="https://www.geeksforgeeks.org/problems/majority-element-1587115620/1?page=1&difficulty=Basic,Easy,Medium&sortBy=submissions">Majority Element</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong>. Find the <strong>majority element</strong> in the array. If no majority element exists, return <strong>-1</strong>.</span></p>
